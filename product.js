...
data.forEach(product=> {
   ...
   <div class="h-[519px]">
     ...
     <img class="h-[519px]" src="${product.image}"  alt="" />
   </div>
 </div>
 <div>
   <div class="flex justify-between mt-5">
     <h2 class="font-bold text-xl leading-[27px]">${product.name}</h2>
     <h2 class="font-bold text-2xl leading-[32.4px]">${product.price} USD</h2>
   </div>
   <p
     class="font-bold text-base leading-[21.6px] text-[#1D1D1D] opacity-50 mt-2.5"
   >
     ${product.category}
   </p>
 </div>`
...
//     <div>
//         <div >
//         <img src="/images/image 18cap.svg" alt="">
//         </div>
//     </div>
//     <div>
// <div class="flex justify-between mt-5">
//     <h2 class="font-bold text-xl leading-[27px]  ">Varsity Cap</h2>
//     <h2 class="font-bold text-2xl leading-[32.4px] ">13.99 USD</h2>
// </div>
//         <p class="font-bold text-base leading-[21.6px] text-[#1D1D1D] opacity-50 mt-2.5">Unisex Caps</p>
//     </div>
// </div>